            ...
            <div className="p-4">
              ...
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {acc.accountType && (
                    <span className={`inline-flex items-center text-[10.5px] font-bold px-2 py-0.5 rounded-full mt-1 ${isDark ? "bg-white/10 text-[#A1A1AA]" : "bg-[#f9fbff]/70 text-[#0C2472]"}`}>
                      {acc.accountType}
                    </span>
                  )}
                </div>
              ...
              <div className="space-y-1.5">
                ...
                {acc.website && (
                  <div className={`flex items-center gap-2 text-[11.5px] truncate ${isDark ? "text-[#A1A1AA]" : "text-slate-700"}`}>
            ...
            <div className={`flex items-center justify-between px-4 py-2.5 border-t ${
              ...
              <Tooltip title={acc.ownerName}>
                <div className="flex items-center gap-1.5">
                  ...
                  <span className={`text-[10.5px] font-medium ${isDark ? "text-[#71717A]" : "text-slate-600"}`}>{acc.ownerName}</span>
                </div>
              </Tooltip>
              <span className={`text-[10px] ${isDark ? "text-[#52525B]" : "text-slate-500"}`}>{acc.creation.split(",")[0]}</span>
            </div>
          </div>
        );
      })}
